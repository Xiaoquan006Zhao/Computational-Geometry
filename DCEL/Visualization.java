...
/***
 * Using javafx to display the convex hull after calculation using either
 * implementation. One example is given below in main method.
 */
...
public class Visualization extends Application {
	 ...
	 // the y coordinate is reversed. (keep this in mind if you want to modify the
	 // code).
	 ...
	 // helper method for loadDCEL(DCEL dcel) and reload(). Also can be called
	 // independently.
	 // load vertices data and updates the coordinates of vertices according to the
	 // view window.
	 ...
	 // helper method for loadDCEL(DCEL dcel) and reload(). Also can be called
	 // independently.
	 // load edges data and updates the coordinates of endpoints of edge according to
	 // the view window.
